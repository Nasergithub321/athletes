          ...
          actions={[
            {
              content: (
                <ContextMenu
                  ...
                  Link={Link}
                >
                  <User image="url('/icons/icon-72x72.png')" name={ userService.userValue.user.first_name +' ' +userService.userValue.user.last_name} title="Manger" size="Medium" />
                </ContextMenu>
              ),
            },
          ]}
